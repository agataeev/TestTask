...
public class Repository<TEntity> : IRepository<TEntity> where TEntity : BaseEntity
{
    ...
    public async Task<TEntity> GetByIdAsync(long id, IEnumerable<string> entitiesToInclude) => await _entities.Include(entitiesToInclude)
                                                                                                             .FirstOrDefaultAsync(e => e.Id == id);

    public async Task<TEntity> GetByUsernameAsync(IEnumerable<Expression<Func<TEntity, bool>>> predicates, IEnumerable<string> entitiesToInclude = null) => await _entities.Filter(predicates)
